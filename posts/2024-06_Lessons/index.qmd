...
better to get it in the right range from the outset!
...
One thing that has worked for me is to draw up a proposal from your side
which states what it is you propose to do under the contract. This sets
out your understanding of the work, and ensures you are on the same page
as them from the outset. It also acts as a reference in case things go
astray at any point.
